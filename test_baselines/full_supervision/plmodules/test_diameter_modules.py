...
def test_full_supervision_module_forward():
    """Test forward method"""
    ...
    # Create module
    module: CarotidArteryFullSupervisionNet \
...
def test_full_supervision_module_training_step():
...
def test_full_supervision_module_validation_step():
...
def test_full_supervision_module_test_step():
...
def test_full_supervision_module_compute_losses():
    """Test compute_losses"""
    parser = argparse.ArgumentParser(
            description='Process hyperparameters'
        )
